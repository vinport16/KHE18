...
BTL2b = [
	{price:300, name:"High Frequency Healthy Tower", maxHealth: 300, color:"#0000c3", tree: false}, 
...
HTL2a = [
	{price:600, name:"High Health and Damage Heavy Tower", maxHealth: 300, color:"#874400", tree: false}, 
...
STL2b = [
	{price:700, name:"High Health", health: 300, color:"#565656", tree: false},
...
BBL2b = [{price:350, name:"Thicc Gaurd", maxHealth: 700, color:"gold", tree: false}];
basicBuildingTree = [{price:150, name:"Battery", energyMax: 300, color:"yellow", tree: BBL2a},
					 {price:150, name:"Wall of Security", maxHealth: 500, color:"silver", tree: BBL2b}];
