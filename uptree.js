...
basicTowerUpgrades = [
  { price: 150, upgradeName: "faster bullets", type: 0, range: 2, color: "#4e4eff", next: { price: 150, upgradeName: "More damage", type: 0, damage: 2, color: "#4e4eff", next: { price: 150, upgradeName: "More range", type: 0, range: 2, color: "#4e4eff", next: null } } },
  { price: 150, upgradeName: "four-shot ", type: 1, newS: "multiShotTower", next: { price: 150, upgradeName: "Multi-shot ", type: 1, newS: "multiShotTower", next: { price: 150, upgradeName: "laser-shot ", type: 1, newS: "multiShotTower", next: null } } }
]
